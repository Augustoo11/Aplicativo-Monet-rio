...
export const estilosHome = StyleSheet.create({
  ...
  logoBox: { width: 35, height: 35, backgroundColor: CORES.azul, borderRadius: 8, justifyContent: 'center', alignItems: 'center', marginRight: 10 },
  logoImagem: { width: 20, height: 20, tintColor: '#fff' },
  logoTexto: { fontSize: 20, fontWeight: 'bold', color: CORES.textoClaro },
  ...
  labelSaldo: { color: CORES.textoEscuro, fontSize: 12, marginBottom: 24 },
  ...
  itemTransacao: { flexDirection: 'row', alignItems: 'center', backgroundColor: CORES.cartao, padding: 16, borderRadius: 16, marginBottom: 10, borderWidth: 1, borderColor: CORES.borda },
  iconeTransacao: { width: 40, height: 40, borderRadius: 20, backgroundColor: CORES.fundo, justifyContent: 'center', alignItems: 'center', marginRight: 14 },
  nomeTransacao: { color: CORES.textoClaro, fontSize: 15, fontWeight: 'bold' },
  dataTransacao: { color: CORES.textoEscuro, fontSize: 12, marginTop: 4 },
  ...
  // ── Seção de meta (no modal de transação) ──────────────────
  secaoMeta: {
  ...
  // Botões grandes de escolha: Normal vs Para meta
  botaoTipoMeta: {
    flex: 1,
    padding: 14,
    borderRadius: 12,
  ...
  // Mini barra de progresso dentro do botão de meta
  miniBarraFundo: {
    height: 4,
  ...
  // Aviso quando não há metas disponíveis
  avisoSemMeta: {
    flexDirection: 'row',
    alignItems: 'center',
    gap: 8,
